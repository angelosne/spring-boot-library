...
public class LibraryApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Book TheLostContinent = new Book("The Lost Continent","Congenital quadriplegia","Darrell","Tebb", BookGenre.NOVEL,50,UK);
		Book MyWayHome=new Book( "Így jöttem" , "Reiter arthritis-up/arm","Margery","D'Antuoni",BookGenre.CRIME,206,Netherlands);
